...
constexpr auto qt_meta_stringdata_CLASSInputHandlerENDCLASS = QtMocHelpers::stringData(
    "InputHandler",
    "failedLoginSignal",
    "",
    "errorState",
...
void InputHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->validInput((*reinterpret_cast< std::add_pointer_t<QJsonObject>>(_a[1]))); break;
        case 2: _t->handleRequest((*reinterpret_cast< std::add_pointer_t<QJsonObject>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (InputHandler::*)(int );
            if (_t _q_method = &InputHandler::failedLoginSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (InputHandler::*)(QJsonObject );
            if (_t _q_method = &InputHandler::validInput; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void InputHandler::failedLoginSignal(int _t1)
{
...
// SIGNAL 1
void InputHandler::validInput(QJsonObject _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
